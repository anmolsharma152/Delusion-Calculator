...
export default function CommentBox({ comment, onRefreshComment }: CommentBoxProps) {
  return (
    <div className="w-full relative glass-card-vapor p-5 border-2 border-[#FF007F]/40 shadow-[0_0_25px_rgba(255,0,127,0.2)] overflow-hidden rounded-xl">
      ...
      {/* Roast Content - High Contrast White text */}
